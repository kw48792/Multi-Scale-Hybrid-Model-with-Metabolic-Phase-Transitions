...
theta.add('vmax3f_0', value=1.42073394869049, min=0, max=2*1E2)
...
theta.add('vmax18r_0', value=0.006, min=0, max=0.1*1E2)
...
##Late Exponential Phase
theta.add('vmax2_1', value=0.10701946222030127, min=0, max=4*1E2)
...
theta.add('vmax18r_1', value=0.0035, min=0, max=0.1*1E2)
...
theta.add('vmax28_1', value=0.00022, min=0, max=0.1*1E2)
...
##Stational Phase
theta.add('vmax2_2', value=0.05401946222030127, min=0, max=4*1E2)
...
theta.add('vmax16r_2', value=0.0033, min=0, max=0.1*1E2)
theta.add('vmax18f_2', value=0.002, min=0, max=1*1E2)
theta.add('vmax18r_2', value=0.004, min=0, max=0.1*1E2)
...
##Decline Phase
theta.add('vmax2_3', value=0.08705865745511, min=0, max=4*1E2)
...
theta.add('vmax18r_3', value=0.004, min=0, max=0.1*1E2)
theta.add('vmax19_3', value=0.003262152166469912, min=0, max=0.1*1E2)
theta.add('vmax21_3', value=0.0056, min=0, max=1*1E2)
theta.add('vmax23_3', value=0.0053, min=0, max=1*1E2)
theta.add('vmax25_3', value=0.0038, min=0, max=1*1E2)
...
theta.add('vmax28_3', value=0.00035, min=0, max=0.1*1E2)
...
with open('params_C.pkl', 'wb') as f:
    pickle.dump(theta, f)
...
def objective_print_single(params):
    val = objective_function_single(params, target_key='EASP')
    eval_counter['n'] += 1
...
try:
    ...
    val = objective_function_single(res.params, target_key='EASP')
